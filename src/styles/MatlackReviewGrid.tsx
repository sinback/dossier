...
const SUPPORTED_LETTERS = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'] as const;
...
const LETTER_PARAMS = {
  ...
  u: {},  // single descent/rise stroke — like nerfed 'w'
  v: {},  // V-stroke + fat exit
  z: { barBowl: { position: { dx: 0, dy: -4 }, fine: { dx: 0, dy: -4 } } },
  x: {
